...
private int varianceAmount = Integer.MAX_VALUE;
	...
	public BruteForceThread(int threadNum, CalculatedSheet calculatedSheet, ObservedSheet observedSheet, double minStuffAmt, double minMovementAmt, double minControlAmt, double minStuffAmtRight, double minMovementAmtRight,
	...
	public void run() {
		...
		//System.out.println("Thread: " + threadNum + " Iterations: " + totalIterations + ": " + minStuffAmt + "-" + maxStuffAmt + " /// " + minMovementAmt + "-" + maxMovementAmt + " /// " + minControlAmt + "-" + maxControlAmt + " /// " + minStuffAmtRight + "-" + maxStuffAmtRight + " /// " + minMovementAmtRight + "-" + maxMovementAmtRight + " /// " + minControlAmtRight + "-" + maxControlAmtRight);
		...
		isRunning = false;
		//System.out.println("Thread " + threadNum + " finished calculating " + iterations + " ---- Variance = " + varianceAmount);
	}
